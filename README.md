...
- Three local expedition slots with save/load/reset, active-slot autosave, and JSON export/import
- v7 saves resume the player position, view direction and paused-safe world time
