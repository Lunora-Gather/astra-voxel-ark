...
const contentChecks = [
  ...
  ['src/app/MainRuntimeWorkQueue.ts', 'MainRuntimeQueueLike'],
  ...
  ['src/app/MainRuntimeWorkQueue.ts', 'consume?:'],
  ['src/app/MainRuntimeWorkQueue.ts', 'consume: (limit, run)'],
  ['src/app/MainRuntimeWorkQueue.ts', 'compactAfterRead'],
  ['src/app/MainRuntimeWorkQueue.ts', 'if (queue.consume) return queue.consume(limit, run)'],
  ...
  ['src/app/MainRuntimeWorkQueue.ts', 'runMainRuntimeQueueLike'],
  ['src/app/MainRuntimeWorkQueue.ts', 'getMainRuntimeQueuePending'],
  ['src/app/MainRuntimeWorkQueue.ts', 'isMainRuntimeTaskQueue'],
  ['src/app/MainRuntimeWorkQueue.ts', 'runMainRuntimeQueueLike(queues.terrainQueue'],
  ['src/app/MainRuntimeWorkQueue.ts', 'runMainRuntimeQueueLike(queues.dirtyChunkSummaryQueue'],
  ...
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'createMainRuntimeTaskQueue'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'createMainRuntimeUniqueTaskQueue'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'runMainRuntimeWorkQueues'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'planMainRuntimeWork'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'requeuedAfterDrain'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'consumeProcessed'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'consumeProcessedItems'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'queueLikeDirtyProcessed'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'queueLikeProcessedItems'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'consume-a,consume-b'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'chunk-a,chunk-b,chunk-a'],
  ['src/app/MainRuntimeWorkQueueSmoke.ts', 'dirty-a,dirty-b'],
  ...
  ['src/app/MainBootstrapSmoke.ts', 'terrainTaskKey'],
  ['src/app/MainBootstrapSmoke.ts', 'dirtyChunkSummaryTaskKey'],
  ['src/app/MainBootstrapSmoke.ts', 'orchestratorInitialDirtyPending'],
